...
window.addEventListener('load', function() {
	...
	var getGameStatuCall = function() {
		abkContract.methods.gameStatu().call({from: userAccount}, function(err, gameStatu) {
			if (err) {
				console.log(err);
				return
			}
